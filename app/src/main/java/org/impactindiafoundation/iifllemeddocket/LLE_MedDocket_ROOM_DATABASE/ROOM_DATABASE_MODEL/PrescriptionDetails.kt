...
data class PrescriptionDetails(
    ...
    data class PatientPrescription(
        ...
        val re_reading_addition_left: Any,
        val re_reading_addition_left_details: Any,
        val re_reading_addition_right: Any,
        val re_reading_addition_right_details: Any,
        val re_remark_left: String,
        val re_remark_right: String,
        val re_remarks: String,
        val reading_glass: Any,
        val user_id: Int
    )
}