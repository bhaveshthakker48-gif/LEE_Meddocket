...
class EntPatientReportAdapter(
    val context: Context,
    val data: ArrayList<EntPatientReport>,
    val event: PatientReportAdapterEvent
) :
    RecyclerView.Adapter<EntPatientReportAdapter.PatientReportViewHolder>() {

    inner class PatientReportViewHolder(
        private var binding: ItemEntCampPatientListBinding,
        var context: Context
    ) :
    ...
    override fun onCreateViewHolder(
        ...
        val binding =
            ItemEntCampPatientListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
