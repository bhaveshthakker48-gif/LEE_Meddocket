...
class FollowUpsAdapter1(context: Context, arrayList: ArrayList<FollowUpsData>):RecyclerView.Adapter<FollowUpsAdapter1.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FollowUpsAdapter1.ViewHolder {
        return ViewHolder(
            AdapterFollowUpsBinding.inflate(
                LayoutInflater.from(context),parent,false))
    }

    override fun onBindViewHolder(holder: FollowUpsAdapter1.ViewHolder, position: Int) {
