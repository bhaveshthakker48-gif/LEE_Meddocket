...
class Adapter_Eye_Pre_Op_Notes_History(context: Context, historyOfArrayList: ArrayList<String>) :
    RecyclerView.Adapter<Adapter_Eye_Pre_Op_Notes_History.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: AdapterEyePreOpNotesHistoryBinding) :
