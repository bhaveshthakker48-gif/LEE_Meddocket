...
class Adapter_Pre_Op_Notes(
    ...
    inner class ViewHolder(val binding:AdapterEyePreOpNotesBinding):RecyclerView.ViewHolder(binding.root)
    {
        fun bind(data: Eye_Pre_Op_Notes, position: Int) {
            ...
            binding.RecyclerViewHistoryOf.adapter = Adapter_Eye_Pre_Op_Notes_History(context, HistoryOfArrayList1!!)
