...
class Adapter_Eye_Pre_Op_Investigation(
    ...
    inner class ViewHolder(val binding: AdapterEyePreOpInvestigationBinding) :
        ...
        fun bind(data: Eye_Pre_Op_Investigation, position: Int) {
            ...
            for (i in extractedDataList1.indices) {
                if (i < AddSliteLampArrayList!!.size) {
                    AddSliteLampArrayList!![i].selected_eye_symptoms_details =
                        extractedDataList1[i].selected_eye_symptoms_details
                }
            }
